...
// New plan sheet
export const NEW_PLAN_TITLE_MAX = readEnvInt('EXPO_PUBLIC_NEW_PLAN_TITLE_MAX', 80)
export const NEW_PLAN_DESCRIPTION_MAX = readEnvInt('EXPO_PUBLIC_NEW_PLAN_DESCRIPTION_MAX', 300)
